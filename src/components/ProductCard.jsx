...
const ProductCard = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      />
      {discount > 0 && (
        <div className="bg-orange-clr text-white -rotate-45 absolute top-3 -left-12 py-2 w-[200px]">
          {discount}% off
        </div>
      )}
      <div className="w-full ">
        <img
          className="w-[200px] h-[200px] object-contain mx-auto mt-10  sm:w-[80%] sm:h-[140px] sm:object-cover lg:w-[85%] "
          src={img}
          alt="Product image"
        />
      </div>
