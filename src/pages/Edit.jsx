...
const Create = () => {
  ...
  const productInfo = useSelector((state) => state.edit.product);
  ...
  async function uploadEditedProductToFirebase(e) {
    e.preventDefault();
  ...
  return (
    <>
      ...
      <main className="w-screen py-12">
        <h1 className="text-center text-xl font-medium">Edit Product</h1>
        <form
          className="w-[85%] max-w-screen-md mx-auto mt-5 pb-5"
          onSubmit={uploadEditedProductToFirebase}
        >
